...
function SushiBlock({ imageUrl, price, title, description, amount}) {
  ...
  return (
    <div className="sushi-block-wrapper">
      <div className="sushi-block">
        ...
        <p className="sushi-block__description">{description}</p>
        ...
        <div className="sushi-block__bottom">
          <div className="sushi-block__price">{price.toFixed(2)} руб.</div>
